      ...
      children: [
        {
          ...
          children: [
            { title: '个数', dataIndex: 'deptHasCount', key: 'deptHasCount', align: 'center', width: 80, customHeaderCell: () => ({ class: 'is-leaf-metric' }), customRender: ({ text }) => renderClickableValue('deptHasCount', text) },
            { title: '金额', dataIndex: 'deptHasAmt', key: 'deptHasAmt', align: 'center', width: 80, customHeaderCell: () => ({ class: 'is-leaf-metric' }), customRender: ({ text }) => renderClickableValue('deptHasAmt', text) }
          ]
        }
      ]
    },
    ...
    { 
      ...
      children: [
        { 
          ...
          children: [
            { title: '个数', dataIndex: 'diffRevCount', key: 'diffRevCount', align: 'center', width: 80, customHeaderCell: () => ({ class: 'is-leaf-metric' }), customRender: ({ text }) => renderClickableValue('diffRevCount', text) },
            { title: '金额', dataIndex: 'diffRevAmt', key: 'diffRevAmt', align: 'center', width: 80, customHeaderCell: () => ({ class: 'is-leaf-metric' }), customRender: ({ text }) => renderClickableValue('diffRevAmt', text) }
          ]
        },
        { 
          title: '采购', 
        ...
        { 
          ...
          customHeaderCell: () => ({ class: 'subgroup-header-cell is-sub-group' }),
          children: [
            { title: '个数', dataIndex: 'diffGrossCount', key: 'diffGrossCount', align: 'center', width: 80, customHeaderCell: () => ({ class: 'is-leaf-metric' }), customRender: ({ text }) => renderClickableValue('diffGrossCount', text) },
            { title: '金额', dataIndex: 'diffGrossAmt', key: 'diffGrossAmt', align: 'center', width: 80, customHeaderCell: () => ({ class: 'is-leaf-metric' }), customRender: ({ text }) => renderClickableValue('diffGrossAmt', text) }
          ]
        }
      ]
    }
